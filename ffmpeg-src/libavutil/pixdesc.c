...
#define BAYER8_DESC_COMMON(flags) \
        /*.nb_components = */3, \
        /*.log2_chroma_w = */0, \
        /*.log2_chroma_h = */0, \
        /*.flags = */flags,    \
...
#define BAYER16_DESC_COMMON(flags) \
        /*.nb_components = */3, \
        /*.log2_chroma_w = */0, \
        /*.log2_chroma_h = */0, \
        /*.flags = */flags,    \
    ...
    [AV_PIX_FMT_BAYER_BGGR8] = {
        /*.name = */"bayer_bggr8",
        BAYER8_DESC_COMMON(AV_PIX_FMT_FLAG_RGB)
    },
    ...
    [AV_PIX_FMT_BAYER_BGGR16LE] = {
        /*.name = */"bayer_bggr16le",
        BAYER16_DESC_COMMON(AV_PIX_FMT_FLAG_RGB)
    },
    [AV_PIX_FMT_BAYER_BGGR16BE] = {
        /*.name = */"bayer_bggr16be",
        BAYER16_DESC_COMMON(AV_PIX_FMT_FLAG_BE | AV_PIX_FMT_FLAG_RGB)
    },

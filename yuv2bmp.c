...
int yuv2bmpdata(YUV_FORMAT format, U8 yuv[], U8 bmp[], int width, int height)
{
    int result = 0;
    ...
    {
        case YUV_I420:
            decodeI420(yuv, width, height, pitch, bmp);
            break;
        case YUV_YV12:
            decodeYV12(yuv, width, height, pitch, bmp);
            break;
        case YUV_NV12:
            decodeNV12(yuv, width, height, pitch, bmp);
            break;
        case YUV_NV21:
            decodeNV21(yuv, width, height, pitch, bmp);
            break;
        default:
            result = -1;
            break;
...
Bitmap *yuv2bmp(YUV_FORMAT format, U8 yuv[], int width, int height)
{
    ...
    yuv2bmpdata(format, yuv, bmp->bData.rgb, width, height);

...
void yuv422p_to_bgr24(unsigned char *yuvbuffer, unsigned char *rgbbuffer, int width, int height)
{
...
内存分布
            ...
            +----------+
                w/2
 */
void yuv420p_to_rgb24_1(unsigned char* ybuffer,unsigned char* ubuffer,unsigned char* vbuffer,unsigned char* rgbbuffer, int width,int height)   
{
    int y1, y2, u, v;    
...
void yuv420p_to_rgb24(unsigned char* yuvbuffer,unsigned char* rgbbuffer, int width,int height)   
{
    ...
    yuv420p_to_rgb24_1(yuvbuffer, src_u, src_v, rgbbuffer, width, height);
}
